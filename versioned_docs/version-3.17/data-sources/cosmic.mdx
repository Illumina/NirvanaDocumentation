...
import JSON from './cosmic-json.md'
...
Commercial companies are required to [acquire a license from COSMIC](https://cancer.sanger.ac.uk/cosmic/license). At the moment, this means that our COSMIC content is only available in Illumina's products and services, not in the open source distribution.
...
* [https://cancer.sanger.ac.uk/cosmic/file_download/GRCh37/cosmic/v94/CosmicFusionExport.tsv.gz](https://cancer.sanger.ac.uk/cosmic/file_download/GRCh37/cosmic/v94/CosmicFusionExport.tsv.gz)
* [https://cancer.sanger.ac.uk/cosmic/file_download/GRCh38/cosmic/v94/CosmicFusionExport.tsv.gz](https://cancer.sanger.ac.uk/cosmic/file_download/GRCh38/cosmic/v94/CosmicFusionExport.tsv.gz)
