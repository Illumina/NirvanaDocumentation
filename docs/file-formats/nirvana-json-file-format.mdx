...
:::info
We've put together a [new section that discusses how to parse our JSON files](../introduction/parsing-json) easily using examples in a [Python Jupyter notebook](https://github.com/Illumina/NirvanaDocumentation/blob/master/static/files/parse-nirvana-json.ipynb). In addition, we have information about how to quickly dump content from our JSON file using a tabix-like utility called JASIX.
:::
