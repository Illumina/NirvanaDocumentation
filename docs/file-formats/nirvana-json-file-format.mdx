...
## Parse Nirvana JSON output
- A python jupyter notebook file can be found [here](https://github.com/Illumina/NirvanaDocumentation/blob/master/static/files/parse-nirvana-json.ipynb) with instructions of parsing the JSON output programmatically.
