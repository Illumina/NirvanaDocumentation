...
MITOMAP is unique in that it doesn't offer the data in a downloadable format. As a result, the annotation content in Illumina Annotator is scraped from the following MITOMAP pages:
