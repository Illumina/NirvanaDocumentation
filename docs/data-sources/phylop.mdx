---
title: PhyloP Conservation Scores
---
...
phyloP (phylogenetic p-values) are obtained from the [PHAST package] (http://compgen.bscb.cornell.edu/phast/) for multiple
alignments of vertebrate genomes to the human genome. For GRCh38, the multiple alignments are against 19 mammals and for GRCh37, it is against 45 vertebrate genomes.
