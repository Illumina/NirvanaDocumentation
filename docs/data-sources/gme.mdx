...
The [Greater Middle East (GME) Variome](http://igm.ucsd.edu/gme/index.php) Project is aimed at generating a coding base reference for the countries found in the Greater Middle East.
