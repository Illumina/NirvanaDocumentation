...
* variants with a common parent ID and same coordinates are grouped
    ...
    * Clinical siginificance and validation status are collapesed using the priority strategy described below
...
```
### Download URL
[https://search.clinicalgenome.org/kb/gene-validity.csv](https://search.clinicalgenome.org/kb/gene-validity.csv)
